...
#                 wandb.Image(data[0], caption="Pred: {} Truth: {}".format(classes[pred[0].item()], classes[target[0]])))
...
#     notes='good good study, day day up',
#     tags=['study'],
#     # group='group2',
#     dir='../',
#     # reinit=True,
...
# wandb.init(entity="tanwen", project="pytorch-intro")
